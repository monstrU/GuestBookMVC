...
public static partial class MVC
{
    ...
    public static GuestBook.Controllers.HomeController Home = new GuestBook.Controllers.T4MVC_HomeController();
...
namespace T4MVC
{
    ...
    public class AdminClass
    {
        ...
        public GuestBook.Areas.Admin.Controllers.EntityController Entity = new GuestBook.Areas.Admin.Controllers.T4MVC_EntityController();
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        public static readonly string design_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/design.min.css") ? Url("design.min.css") : Url("design.css");
             
        public static readonly string main_style_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/main_style.min.css") ? Url("main_style.min.css") : Url("main_style.css");
